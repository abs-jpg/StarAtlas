...
namespace AZ.Atlas
{
    ...
    public sealed class AtlasObserverPointPanel : MonoBehaviour
    {
        ...
        private static readonly LocationPreset[] DefaultLocations =
        {
            ...
            new LocationPreset { key = "cn-qinghai", displayName = "\u9752\u6d77\u00b7\u897f\u5b81", latitude = 36.6171, longitude = 101.7782, timeZoneId = "China Standard Time", alternateTimeZoneId = "Asia/Shanghai", fallbackUtcOffsetHours = 8f },
            ...
            new LocationPreset { key = "cn-ningxia", displayName = "\u5b81\u590f\u00b7\u94f6\u5ddd", latitude = 38.4872, longitude = 106.2309, timeZoneId = "China Standard Time", alternateTimeZoneId = "Asia/Shanghai", fallbackUtcOffsetHours = 8f },
